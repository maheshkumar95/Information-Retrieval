...
PlainTextFileFolder = os.getcwd() + '/StemText/'

oneGram_tfTable = 'MyIndex\\OneGram_TfTable_Stem.txt'
oneGram_dfTable = 'MyIndex\\OneGram_DfTable_Stem.txt'
...
oneGram_Stoplist     = 'MyIndex\\Task3_Stoplist_OneGram_Stem.txt'
